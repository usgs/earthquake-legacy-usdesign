...
$MAPTYPE_KEY = array(
	...
	'PGA' => 'Peak Ground Acceleration for MCE',
	'0.2s 10% Probability of Exceedance' => 
		'0.2s Ground Motion, 10% Probability of Exceedance in 50 Years',
	'1.0s 10% Probability of Exceedance' =>
		'1.0s Ground Motion, 10% Probability of Exceedance in 50 Years',
	'0.2s 2% Probability of Exceedance' =>
		'0.2s Ground Motion, 2% Probability of Exceedance in 50 Years',
	'1.0s 2% Probability of Exceedance' =>
		'1.0s Ground Motion, 2% Probability of Exceedance in 50 Years',
);
...
$GLOBALS['DESIGNMAPS_KEY'] = array(
	...
	'NEHRP' => array(
		...
		'2009' => array(
			...
			'Conterminous US' => array(
				'0.2s Deterministic Ground Motions' => '5.pdf',
				'1.0s Deterministic Ground Motions' => '6.pdf',
				'Long-Period Transition' => '7.pdf',
				'PGA' => '8.pdf',
				'0.2s 2% Probability of Exceedance' => '1.pdf',
				'1.0s 2% Probability of Exceedance' => '2.pdf',
				'0.2s Mapped Risk Coefficient' => '3.pdf',
				'1.0s Mapped Risk Coefficient' => '4.pdf',
			),
			'Alaska' => array(
				'PGA' => '9.pdf',
			),
...
function outputCodeListing($code_name, $code_contents, $format = 'normal') {
	if ($format == 'condensed') {
		echo '<h4>' .
			htmlspecialchars($code_contents['display-name']) . '</h4><ul>';
	} else {
		echo '<div class="section"><h2>' .
			htmlspecialchars($code_contents['display-name']) . '</h2><ul>';
	}
	...
	foreach ($code_contents as $edition => $edition_contents) {
		...
		echo '<li><a href="' .
			$prefix . '/hazards/designmaps/pdfs/?code=' .
